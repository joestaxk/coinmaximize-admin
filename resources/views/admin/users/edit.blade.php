                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            <form action="{{route('UserProfileUpdate')}}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="lastname">{{__('Credit Score')}}</label>
                                    <input name="number" type="text" value="{{old('credit_score',$user->credit_score)}}" class="form-control" id="creditScore" placeholder="{{__('')}}">
                                    @error('credit_score')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
